...
<nav>
	...
	<br>
	<h3>Hai ! Good Evening</h3>
	<h4>These are the room services which we provide !</h4>
...
SELECT * from booking;  
	...
	<table border="1" width="50%" align="center">
		<tr>
			...
			<th style="color: Green">Persons</th>
			<th style="color: Green">checkin</th>
			<th style="color: Green">checkout</th>
